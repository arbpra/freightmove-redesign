@component('mail.layout', [
    ...
    'preview' => 'You can enquire on every load from now until ' . ($subscription->ends_on?->format('j F Y') ?? 'further notice') . '.',
])
    ...
    <p style="margin:0 0 18px;font-size:15px;line-height:1.65;color:#475569;">
        Thanks — your payment is confirmed and you can enquire on every load on the board.
    </p>
